        ...
        <tr><td width="546" valign="top" style="border-collapse: collapse;">
                <div style="max-width: 600px; margin: 0 auto;">
                    ...
                    <div style="background: white; border-radius: 0.5rem; margin-bottom: 1rem;">
                        ...
                        <p style="font-size: 17px; line-height: 24px;text-align: left; margin: 0 0 16px;">{!! str_replace( array('%%--link_survey--%%' , '%%--days--%%' , '%%--link_results--%%') , array("<a href='$link'>$link</a>" , $survey->duree , "<a href='$result'>$result</a>") , nl2br($blueprint->intro)) !!}</p>
