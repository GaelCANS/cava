...
@section('content')
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="@if( $blueprint == null ) disabled @endif @if($tab == 'question') active @endif"><a href="@if( $blueprint == null ){{'#'}}@else{{route('list-question',$blueprint)}}@endif">Questions</a></li>
