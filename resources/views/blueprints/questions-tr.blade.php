<li class="questions-admin" data-id="{{$question->id}}">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
                <a href="{{action("QuestionController@destroy" , $question)}}" class="del-btn " title="Supprimer" data-confirm="Voulez-vous vraiment supprimer" data-method="delete"><button type="button" class="btn btn-outline-danger icon-btn"><i class="fa fa-trash"></i></button></a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <div class="radio">
                    <span class="font-weight-bold"><u>Actif</u> : </span>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <div class="radio">
                    <span class="font-weight-bold"><u>Type</u> : </span>
