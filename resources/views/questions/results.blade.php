...
@section('content')
    <div class="row">
        <div class="col-md-8 text-center mx-auto px-4 mb-5">
            ...
            <span class="text-muted mr-5 d-inline-block"><i class="fas fa-window-minimize" style="font-size: 38px;padding-right: 10px;float: left;margin-top: -17px;color:#58bac0;"></i>Moyenne du XX/XX au XX/XX</span>
